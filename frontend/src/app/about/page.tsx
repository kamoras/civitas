        ...
        <div className="max-w-3xl mx-auto">
          ...
          <Section title="KNOWN LIMITATIONS &amp; DISCLOSURES" id="known-limitations">
            ...
            <P>
              ...
              election office. See{" "}
              <a href="#state-ballots" className="underline underline-offset-2 hover:text-matrix-green/70">State Ballots &amp; Ballot Measures</a>.
            </P>
            <Gist>
          ...
          <Section title="STATE BALLOTS &amp; BALLOT MEASURES" id="state-ballots">
            <P>
              Each state has a ballot page at <span className="text-neon-cyan/80">/elections/states/&lt;ST&gt;</span> showing
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <P>
                  ...
                  rewrite. See <span className="text-neon-cyan/80">HOW AI IS USED</span> below
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <P>
                  ...
                  map for selecting states. Selecting a state opens that state&apos;s
                  ballot page (below).
                </P>
              </div>
            ...
            <div className="space-y-4 mt-4">
              ...
              <div>
                ...
                <div className="space-y-2">
                  ...
                  <Row label="Ballot measures" value="No AI touches ballot content at any stage. Titles, summaries, fiscal statements and yes/no descriptions are reproduced verbatim from official sources — see below for why we ruled out a plain-language rewrite." />
                </div>
              </div>
          ...
          <Section title="DATA SOURCES AND APIs">
            ...
            <div className="space-y-2 mt-6">
              <h3 className="text-xs text-matrix-green/50 tracking-widest">ELECTIONS &amp; BALLOT MEASURES</h3>
