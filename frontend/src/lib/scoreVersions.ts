...
export const SCORE_VERSIONS: ScoreVersion[] = [
  {
    ...
    changes: [
      ...
      "Presidents: the averages used to put approval ratings, election margins and historians' rankings on a common scale were also typed-in numbers. They are now measured from the presidents on record each update, and so is the conversion from electoral-college margins to popular-vote margins for early elections.",
