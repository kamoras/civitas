...
export const SCORE_VERSIONS: ScoreVersion[] = [
  {
    ...
    changes: [
      ...
      "This also corrects the stated reason the crossing-side discount below remains unshipped: that reasoning assumed the live ideology data needed to calibrate it doesn't exist outside the production pipeline. It does — this version's own discount is built on it. What's still missing for the crossing-side discount specifically is a dedicated live validation run, not the underlying data.",
    ],
  },
  {
    version: "v6.6",
