...
DONOR_TYPE_HOLDOUT: list[tuple[str, str, str | None]] = [
    ...
    ("Beal Bank", "Org/Employees", None),
    ("Cancer Treatment Center Of America", "Org/Employees", None),
    ("Tower Hill Insurance", "Org/Employees", None),
    ("Marquette Transportation", "Org/Employees", None),
    ("Collum Lumber", "Org/Employees", None),
    ("National Bank Of South Carolina", "Org/Employees", None),
    ("Cincinnati Insurance Co.", "Org/Employees", None),
    ("Mountaire Corp", "Org/Employees", None),
    # Party/Ideological
