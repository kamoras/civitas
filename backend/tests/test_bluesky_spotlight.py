...
class TestMostNotableScore:
    ...
    def test_low_score_is_notable(self):
        key, value, notable = _most_notable_score(_scores(**{"Constituent alignment": 22.0}))
        assert key == "Constituent alignment"
        assert notable is True
...
class TestFormerOfficialStatusGrounding:
    ...
    def test_spotlight_rejects_ungrounded_former_status(self):
        senator = Senator(
            ...
            score_funding_independence=50.0, score_constituent_alignment=50.0,
...
class TestMagnitudeClaimRejection:
    ...
    Constituent alignment 52.0, Legislative effectiveness 74.0 — Legislative
    ...
    def _senator(self):
        return Senator(
            ...
            score_funding_independence=61.0, score_constituent_alignment=52.0,
