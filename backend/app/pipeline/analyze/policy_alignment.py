...
def compute_promise_vote_alignment(
    ...
    With ``use_llm=True`` (Senate pipeline), the local LLM (LFM2.5-1.2B-
    Instruct — see config.py's OLLAMA_MODEL) decomposes the promise into a
    richer semantic query before the embedding search.
