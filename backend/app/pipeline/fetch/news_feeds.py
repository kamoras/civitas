...
# reaches storage BEFORE stripping — rows ingested in the week before this
# fix landed needed a one-time cleanup, since long since applied) leaves a
# tag with no closing ">" for
